...
class CustomDropdownButton2<T> extends StatefulWidget {
  ...
  State<CustomDropdownButton2<T>> createState() =>
      CustomDropdownButton2State<T>();
}

class CustomDropdownButton2State<T> extends State<CustomDropdownButton2<T>>
  ...
  @override
  void didUpdateWidget(CustomDropdownButton2<T> oldWidget) {
