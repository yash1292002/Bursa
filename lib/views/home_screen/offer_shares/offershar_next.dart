...
class OfferShareNext extends StatefulWidget {
  const OfferShareNext({Key? key}) : super(key: key);

  @override
  State<OfferShareNext> createState() => _OfferShareNextState();
}

class _OfferShareNextState extends State<OfferShareNext> {
  @override
