...
class FScanScreen extends StatefulWidget {
  const FScanScreen({Key? key}) : super(key: key);

  @override
  State<FScanScreen> createState() => _FScanScreenState();
}

class _FScanScreenState extends State<FScanScreen> {
  @override
  void initState() {
    super.initState();
    /* Timer(
